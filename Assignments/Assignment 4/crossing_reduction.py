...
def plot_final_graph(result, layer_list, connections_list, dummy_variables):
...
if dummy_variables:
    ...
    coords, node_coords = plot_final_graph(result, new_layer_list, connections_list_new, dummy_variables)
else: 
