...
from Assignments.Assignment_5.clusterMarking import getClusters, combineJSON, drawEllipse, getClusterBoxCoords
import pydot
...
def return_intra_cluster_edges(edge_list, clusters, coords_dict):
    all_edge_list = []
    comp_edge_list = []
...
def drawClusters(FILE_NAME):
    FILE_NAME = f'Networks/{FILE_NAME}.dot'

    path = combineJSON("Assignments/Assignment_5/nodePositions/ArgumentationNetwork")
    ...
    comp_edge_list, curve_edge_list = return_intra_cluster_edges(edge_list, clusters, coords_dict)
...
# TEST
# FILE_NAME = "ArgumentationNetwork"

# drawClusters(FILE_NAME)